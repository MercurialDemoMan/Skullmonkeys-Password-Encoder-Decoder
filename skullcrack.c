...
{
    /* 1st symbol */
    /* 1st bit */ 0x01, 0x00, /* lives = lives | 0x00 */
    /* 2nd bit */ 0x01, 0x01, /* lives = lives | 0x01 */
    /* 3rd bit */ 0x01, 0x02, /* lives = lives | 0x02 */

    /* 2nd symbol */
    /* 1st bit */ 0x01, 0x03, /* lives = lives | 0x03 */
    /* 2nd bit */ 0x00, 0x00, /* level = level | 0x00 */
    /* 3rd bit */ 0x07, 0x00, /* seed  = seed  | 0x00 */

    /* 3rd symbol */
    /* 1st bit */ 0x00, 0x01, /* level = level | 0x01 */
    /* 2nd bit */ 0x07, 0x01, /* seed  = seed  | 0x01 */
    /* 3rd bit */ 0x01, 0x04, /* lives = lives | 0x04 */

    /* 4th symbol */
    /* 1st bit */ 0x06, 0x00, /* 1970s = 1970s | 0x00 */
    /* 2nd bit */ 0x00, 0x02, /* level = level | 0x02 */
    /* 3rd bit */ 0x07, 0x02, /* seed  = seed  | 0x02 */

    /* 5th symbol */
    /* 1st bit */ 0x02, 0x00, /* birds  = birds  | 0x00 */
    /* 2nd bit */ 0x03, 0x00, /* pharts = pharts | 0x00 */
    /* 3rd bit */ 0x04, 0x00, /* enemas = enemas | 0x00 */

    /* 6th symbol */
    /* 1st bit */ 0x05, 0x00, /* willies = willies | 0x00 */
    /* 2nd bit */ 0x01, 0x05, /* lives   = lives   | 0x05 */
    /* 3rd bit */ 0x07, 0x03, /* seed    = seed    | 0x03 */

    /* 7th symbol */
    /* 1st bit */ 0x00, 0x03, /* level = level   | 0x03 */
    /* 2nd bit */ 0x02, 0x01, /* birds = birds   | 0x01 */
    /* 3rd bit */ 0x03, 0x01, /* pharts = pharts | 0x01 */

    /* 8th symbol */
    /* 1st bit */ 0x04, 0x01, /* enemas  = enemas  | 0x01 */
    /* 2nd bit */ 0x05, 0x01, /* willies = willies | 0x01 */
    /* 3rd bit */ 0x06, 0x01, /* 1970s   = 1970s   | 0x01 */

    /* 9th symbol */
    /* 1st bit */ 0x07, 0x04, /* seed  = seed  | 0x04 */
    /* 2nd bit */ 0x01, 0x06, /* lives = lives | 0x06 */
    /* 3rd bit */ 0x00, 0x04, /* level = level | 0x04 */

    /* 10th symbol */
    /* 1st bit */ 0x07, 0x05, /* seed   = seed   | 0x05 */
    /* 2nd bit */ 0x02, 0x02, /* birds  = birds  | 0x02 */
    /* 3rd bit */ 0x03, 0x02, /* pharts = pharts | 0x02 */

    /* 11th symbol */
    /* 1st bit */ 0x04, 0x02, /* enemas  = enemas  | 0x02 */
    /* 2nd bit */ 0x05, 0x02  /* willies = willies | 0x02 */
};
